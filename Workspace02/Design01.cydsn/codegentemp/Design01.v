...
module top ;
    ...
    assign Net_43 = Net_36 ^ Net_49;


    assign Net_75 = ~Net_36;


    assign Net_48 = ~(Net_75 & Net_49);


    assign Net_161 = ~Net_49;


    assign Net_52 = ~(Net_36 & Net_161);

	wire [0:0] tmpOE__chAx_net;
	wire [0:0] tmpIO_0__chAx_net;
	wire [0:0] tmpINTERRUPT_0__chAx_net;
	electrical [0:0] tmpSIOVREF__chAx_net;
	...
	cy_psoc3_pins_v1_10
		...
		chAx
		 (.oe(tmpOE__chAx_net),
		  .y({1'b0}),
		  .fb({Net_36}),
		  .io({tmpIO_0__chAx_net[0:0]}),
		  .siovref(tmpSIOVREF__chAx_net),
		  .interrupt({tmpINTERRUPT_0__chAx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__chAx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__chBx_net;
	wire [0:0] tmpIO_0__chBx_net;
	wire [0:0] tmpINTERRUPT_0__chBx_net;
	electrical [0:0] tmpSIOVREF__chBx_net;

	cy_psoc3_pins_v1_10
		#(.id("55f5ada9-3970-4bae-a6f8-3665e2f944dc"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		chBx
		 (.oe(tmpOE__chBx_net),
		  .y({1'b0}),
		  .fb({Net_49}),
		  .io({tmpIO_0__chBx_net[0:0]}),
		  .siovref(tmpSIOVREF__chBx_net),
		  .interrupt({tmpINTERRUPT_0__chBx_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__chBx_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- SRFF Start --
    reg  cy_srff_1;
    always @(posedge Net_43)
    begin
        cy_srff_1 <= (Net_48 | Net_86) & ~Net_52;
    end
    assign Net_86 = cy_srff_1;
    // -- SRFF End --


    assign Net_4 = ~(Net_85 & Net_75 & Net_161);


    assign Net_5 = ~(Net_75 & Net_161 & Net_86);


    assign Net_85 = ~Net_86;
    ...
    assign Net_96 = ~Net_95;

    // -- SRFF Start --
    reg  cy_srff_2;
    always @(posedge Net_164)
    begin
        cy_srff_2 <= (Net_165 | Net_95) & ~Net_166;
    end
    assign Net_95 = cy_srff_2;
    // -- SRFF End --


    assign Net_166 = ~(Net_88 & Net_162);


    assign Net_162 = ~Net_90;


    assign Net_165 = ~(Net_163 & Net_90);

	wire [0:0] tmpOE__chAy_net;
	wire [0:0] tmpIO_0__chAy_net;
	wire [0:0] tmpINTERRUPT_0__chAy_net;
	electrical [0:0] tmpSIOVREF__chAy_net;

	cy_psoc3_pins_v1_10
		#(.id("1404e41d-cc82-44e9-9d6c-4825743e8996"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		chAy
		 (.oe(tmpOE__chAy_net),
		  .y({1'b0}),
		  .fb({Net_88}),
		  .io({tmpIO_0__chAy_net[0:0]}),
		  .siovref(tmpSIOVREF__chAy_net),
		  .interrupt({tmpINTERRUPT_0__chAy_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__chAy_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__chBy_net;
	wire [0:0] tmpIO_0__chBy_net;
	wire [0:0] tmpINTERRUPT_0__chBy_net;
	electrical [0:0] tmpSIOVREF__chBy_net;

	cy_psoc3_pins_v1_10
		#(.id("c6512965-fbcc-4585-9298-b1cbb93ad48d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		chBy
		 (.oe(tmpOE__chBy_net),
		  .y({1'b0}),
		  .fb({Net_90}),
		  .io({tmpIO_0__chBy_net[0:0]}),
		  .siovref(tmpSIOVREF__chBy_net),
		  .interrupt({tmpINTERRUPT_0__chBy_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__chBy_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_164 = Net_88 ^ Net_90;


    assign Net_7 = ~(Net_96 & Net_163 & Net_162);


    assign Net_8 = ~(Net_163 & Net_162 & Net_95);


    assign Net_163 = ~Net_88;
	...
	wire [0:0] tmpOE__PwmY_net;
	wire [0:0] tmpFB_0__PwmY_net;
	wire [0:0] tmpIO_0__PwmY_net;
	wire [0:0] tmpINTERRUPT_0__PwmY_net;
	electrical [0:0] tmpSIOVREF__PwmY_net;

	cy_psoc3_pins_v1_10
		#(.id("8ad4ff62-f250-4cc4-b347-f66e94fcef6a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PwmY
		 (.oe(tmpOE__PwmY_net),
		  .y({Net_187}),
		  .fb({tmpFB_0__PwmY_net[0:0]}),
		  .io({tmpIO_0__PwmY_net[0:0]}),
		  .siovref(tmpSIOVREF__PwmY_net),
		  .interrupt({tmpINTERRUPT_0__PwmY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PwmY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__PwmX_net;
	wire [0:0] tmpFB_0__PwmX_net;
	wire [0:0] tmpIO_0__PwmX_net;
	wire [0:0] tmpINTERRUPT_0__PwmX_net;
	electrical [0:0] tmpSIOVREF__PwmX_net;

	cy_psoc3_pins_v1_10
		#(.id("70f0dd91-315d-4dab-817f-c03fffb4db7d"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PwmX
		 (.oe(tmpOE__PwmX_net),
		  .y({Net_186}),
		  .fb({tmpFB_0__PwmX_net[0:0]}),
		  .io({tmpIO_0__PwmX_net[0:0]}),
		  .siovref(tmpSIOVREF__PwmX_net),
		  .interrupt({tmpINTERRUPT_0__PwmX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PwmX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("b0a9e548-aff9-45c0-a170-4ef39beefe84"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Reset_Pin_net;
	wire [0:0] tmpIO_0__Reset_Pin_net;
	wire [0:0] tmpINTERRUPT_0__Reset_Pin_net;
	electrical [0:0] tmpSIOVREF__Reset_Pin_net;

	cy_psoc3_pins_v1_10
		#(.id("2b9aa62c-4816-4097-97b0-1d4e982b22ee"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Reset_Pin
		 (.oe(tmpOE__Reset_Pin_net),
		  .y({1'b0}),
		  .fb({Net_183}),
		  .io({tmpIO_0__Reset_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__Reset_Pin_net),
		  .interrupt({tmpINTERRUPT_0__Reset_Pin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Reset_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("8d626cd0-d5f3-481c-85c1-4926f909e739"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63d7301f-14b8-45e9-a09b-b92bc3fcfcff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("3f5fe12f-a49f-4e79-a15e-8432fe6bffc3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c72389af-7656-401b-864c-ff9d11019a5c"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
