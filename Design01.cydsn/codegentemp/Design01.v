...
module top ;
	...
	wire [0:0] tmpOE__SenX_net;
	wire [0:0] tmpIO_0__SenX_net;
	wire [0:0] tmpINTERRUPT_0__SenX_net;
	electrical [0:0] tmpSIOVREF__SenX_net;

	cy_psoc3_pins_v1_10
		#(.id("92396429-229e-4cdb-a32e-d6bbaf111269"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SenX
		 (.oe(tmpOE__SenX_net),
		  .y({1'b0}),
		  .fb({Net_232}),
		  .io({tmpIO_0__SenX_net[0:0]}),
		  .siovref(tmpSIOVREF__SenX_net),
		  .interrupt({tmpINTERRUPT_0__SenX_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SenX_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SenY_net;
	wire [0:0] tmpIO_0__SenY_net;
	wire [0:0] tmpINTERRUPT_0__SenY_net;
	electrical [0:0] tmpSIOVREF__SenY_net;

	cy_psoc3_pins_v1_10
		#(.id("3725dd4d-553b-4d9a-8f57-a18c90b80107"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		SenY
		 (.oe(tmpOE__SenY_net),
		  .y({1'b0}),
		  .fb({Net_231}),
		  .io({tmpIO_0__SenY_net[0:0]}),
		  .siovref(tmpSIOVREF__SenY_net),
		  .interrupt({tmpINTERRUPT_0__SenY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SenY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
